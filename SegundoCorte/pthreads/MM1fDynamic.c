...
// #pragma omp master
//     initTransposeMatrixDynamic(MATRIX_SIZE, matrixA, matrixB, transposeMatrixB, result);
...
//     sample_end();
//   }
  matrixDynamicTransposeFree(MATRIX_SIZE, matrixA, matrixB, result, transposeMatrixB);
  return 0;
}
